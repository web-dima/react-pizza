...
import {clearCart, deletePizza, addOnePizza, removeOnePizza} from "../redux/actions/cart"
...
function Cart() {
    ...
    const pizzaGroup = Object.keys(items).map(i => items[i].items[0]);
